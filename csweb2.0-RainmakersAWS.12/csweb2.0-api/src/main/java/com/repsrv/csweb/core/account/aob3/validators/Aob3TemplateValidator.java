...
public class Aob3TemplateValidator implements ExcellSheetsConstants{
 
     private static final String DUPLICATE_KEY_ERROR_MSG = "Found duplicate value in row %s for column %s";
     private Aob3TemplateValidator(){}

     public static Gson gsonCreate() {

	final Map<String, String> gsonExcludes = new HashMap<>();
		gsonExcludes.put("aob3Sites","");
		gsonExcludes.put("aob3Containers","");
		gsonExcludes.put("aob3Rates","");
		// gsonExcludes.put("rowIndex","");
