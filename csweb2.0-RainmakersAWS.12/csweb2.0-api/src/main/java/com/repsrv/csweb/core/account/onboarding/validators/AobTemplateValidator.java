...
public class AobTemplateValidator implements ExcellSheetsConstants{
 
     private static final String DUPLICATE_KEY_ERROR_MSG = "Found duplicate value in row %s for column %s";
     private AobTemplateValidator(){}

     public static Gson gsonCreate() {

	final Map<String, String> gsonExcludes = new HashMap<>();
		gsonExcludes.put("aobSites","");
		gsonExcludes.put("aobContainers","");
		gsonExcludes.put("aobRates","");
