...
@Component({
  selector: 'app-preview-live3',
  templateUrl: './preview-live.component3.html',
  styleUrls: ['./preview-live.component3.css']
})
export class PreviewLiveComponent3 implements OnInit {
